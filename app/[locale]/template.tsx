  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 pb-6 md:p-0 w-full md:h-screen transition duration-1000 ease-in-out text-neutral-800 dark:text-white">
      <div className="md:relative md:blur-bg md:py-3 md:rounded-3xl">
        ...
        <div className="flex flex-col items-center justify-center pt-2 md:pt-0 w-full md:min-w-basic-page-m lg:min-w-basic-page md:max-w-fit">
          <motion.div
            layoutId="border-div"
            className={clsx(
          ...
          >
            <motion.div
              className="pb-8 md:py-8 md:px-2 w-full grid place-content-center"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={
